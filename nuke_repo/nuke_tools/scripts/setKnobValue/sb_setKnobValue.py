...
# 1.1.0 - download to nukepedia
# 2.0.0 - refactor to python 3 (tools 2to3.py)
# -----------------------------------------------------------------------------
...
class sb_setKnobValue_Panel(nukescripts.PythonPanel):
	...
	def setKnobValue(self):
		...
		scriptName = sb_setKnobValue_Data()["scriptName"]
		print (f"{scriptName} : Updated knobs: {updatedNodes}.")
