...
nuke_tools_path = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
CUSTOM_GIZMO_LOCATION = os.path.join(nuke_tools_path, 'gizmos')
nuke.tprint('CUSTOM_GIZMO ', CUSTOM_GIZMO_LOCATION)
